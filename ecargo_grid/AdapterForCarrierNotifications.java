...
public class AdapterForCarrierNotifications  extends BaseAdapter implements ListAdapter {
    ...
    public AdapterForCarrierNotifications(Activity activity, JSONArray jsonArray,String ApiKey,JSONObject jsonObject) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null)
            convertView = activity.getLayoutInflater().inflate(R.layout.rowforcarriernotifications, null);


        TextView custome_user_name = (TextView) convertView.findViewById(R.id.carrier_user_name);
        TextView urun_name = (TextView) convertView.findViewById(R.id.urun_name);
        TextView check_icon = (TextView) convertView.findViewById(R.id.check_icon);
        TextView cancel_icon = (TextView) convertView.findViewById(R.id.cancel_icon);
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    if(sonuc.getString("error").equals("false")) {
                                        ...
                                        CarrierNotificationsActivity.adapterForCarrierNotifications.notifyDataSetChanged();
                                    }
                                } catch (JSONException e) {
                                    e.printStackTrace();
                                }
...

                {
                    ...
                    protected Map<String, String> getParams() throws AuthFailureError {
                        ...
                        try {
                            ...
                            params.put("SenderID", json_data.getString("CustomerSenderID"));

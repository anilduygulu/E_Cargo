...
public class JSONAdapterForListRoutes extends BaseAdapter implements ListAdapter {
    public final Activity activity;
    public final JSONArray jsonArray;
    public String ApiKey;
    String url = "https://ecargo.info/Api/v1/routes/deleteRoute";
    String TAG = "JSONAdapterForListRoute activity";
    static String routeID;
    public JSONAdapterForListRoutes(Activity activity, JSONArray jsonArray, String ApiKey) {
    ...
    @Override public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(null!=json_data ){
            ...
            try {
                car_plate1 = json_data.getString("RouteFrom");
                car_brand1 = json_data.getString("RouteTo");
                car_model1 = json_data.getString("RouteDate");
        ...
        carDeleteIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                JSONObject json_data = getItem(position);
                try {
                    routeID = json_data.getString("RouteID");
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    if(sonuc.getString("error").equals("false")) {
                                        ...
                                        CarrierRouteActivity.jsonAdapterForListRoutes.notifyDataSetChanged();
...

                {
                    ...
                    public Map<String, String> getHeaders() throws AuthFailureError {
                        ...
                        Log.d(TAG, "Apikey on Listroute function: " + ApiKey);
